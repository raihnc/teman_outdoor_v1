...
import '../../features/admin/views/admin_product_list_view.dart';
import '../../features/admin/views/admin_product_form_view.dart';
import '../../features/admin/views/admin_order_list_view.dart';
import '../../features/admin/views/admin_order_detail_view.dart';
import '../../features/admin/views/admin_banner_view.dart';
...
class AppPages {
  static final pages = [
    ...
    GetPage(
      name: AppRoutes.adminBannerList,
      page: () => const AdminBannerView(),
      customTransition: RightToLeftJoinedTransition(),
      transitionDuration: const Duration(milliseconds: 400),
      curve: Curves.easeInOut,
    ),
